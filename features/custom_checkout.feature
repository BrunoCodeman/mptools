Feature: Custom Checkout
	...
	I'm accessing, go to checkout, fill my personal data and the shipment data. After that, I must see a payment 
	form, fill the fields with my card data and confirm the order. After the payment is processes, 
